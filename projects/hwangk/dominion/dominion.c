...
//prototypes for assignment 2 functions
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  //uses if statements to select card and perform actions for assignment 2
  if(card == adventurer)
  {
  ...
  if(card == smithy)
  {
	playSmithy(i, currentPlayer, state, handPos);
	return 0;
  }
...
//separate functions for adventurer, smithy, village, great hall, and steward (assignment 2)
int playAdventurer(int drawntreasure, struct gameState *state, int currentPlayer, int temphand[], int z)
{
